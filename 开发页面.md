...
![image](https://note.youdao.com/yws/res/9318/261A2385198C4BA49C26937C8360F245)

然后在test文件夹上右击，点击新建page，并命名为test（一般为了方便后期查找页面和代码，我们将页面的名字和文件夹的名字设置为同一个）：

![image](https://note.youdao.com/yws/res/9321/3B5428BC179A4D80A66B2B03A62ACB81)

![image](https://note.youdao.com/yws/res/9329/D628BF29D3844ABEA58AD34CD6034619)
...
![image](https://note.youdao.com/yws/res/9406/10811FF739784DC2A85FE3CC4DE556D5)
...
![image](https://note.youdao.com/yws/res/9436/2F5410BFBD9D47CAA79BD26BE8AFED2B)
...
![image](https://note.youdao.com/yws/res/9505/7AF8144CF63247659661D09CE01EECC1)
...
![image](https://note.youdao.com/src/91802D7840F94DD0B931721A2853F302)
![image](https://note.youdao.com/yws/res/9475/F61AE4DCFE124EDEA2DC1F9115DF153A)
...
![image](https://note.youdao.com/yws/res/9538/1BB46D34EC844F7BAAF67C9A45C49891)
...
![image](https://note.youdao.com/yws/res/9558/2ADF2F6FE0CB48B89A1BD0CDA2632C20)
...
运行结果如下：
![image](https://note.youdao.com/yws/res/9589/BA630C641A5E45DA9C42B42E706B6B78)
...
![image](https://note.youdao.com/yws/res/9659/B4B2C4C6E57040EE86490205E432F65D)
...
![image](https://note.youdao.com/yws/res/9646/C2435764F9A44060A5C8D6BA5C65BEFE)

如果在changeData2方法中，我们没有使用setData方法同步数据，那么此时在页面上的array内容则为[1,2,3]，而我们在js文件方法中log出来的array内容为[4,5,6]。造成显示与数据不符的结果。

![image](https://note.youdao.com/yws/res/9653/2CD7B11BD0334B9CBC09DEDDBBC92977)
...
```
运行结果如下：
![image](https://note.youdao.com/yws/res/9721/7F3ECE72E8864D2E8B76C4852D9FDC92)
